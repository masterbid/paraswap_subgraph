...
export class AugustusSwapper extends ethereum.SmartContract {
  static bind(address: Address): AugustusSwapper {
    return new AugustusSwapper("AugustusSwapper", address);
  }
...
export class MultiSwapCallPathStruct extends ethereum.Tuple {
  ...
  get routes(): Array<MultiSwapCallPathRoutesStruct> {
    return this[1].toTupleArray<MultiSwapCallPathRoutesStruct>();
  }
}
